...
def get_best_match(user_input, responses):
    ...
    for key in responses.keys():
        key_lower = key.lower()
        ratio = SequenceMatcher(None, key_lower, user_input_lower).ratio()
...
class SimpleChatbot:
    ...
    def get_response(self, question):
        ...
        matched_question = get_best_match(user_input, chatbot.responses)
        response = chatbot.responses[matched_question] if matched_question else "Sorry, I don't understand that question."
